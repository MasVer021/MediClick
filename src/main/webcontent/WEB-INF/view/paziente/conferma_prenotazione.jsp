			...
			<div class="mc-card mc-card--generic">
				...
				<div id="cardRiepilogo" class="mc-card__body mc-flex-col mc-gap-md">
					...
					<div class="mc-flex-col">
						...
						<span class="mc-text-bold mc-font-md">DR. ${riepilogo.medico.cognome}
							${riepilogo.medico.nome}</span>
					</div>
					...
					<form method="post" action="<c:url value='/paziente/prenotazione'/>" class="mc-flex-col mc-gap-md">
						...
						<div class="mc-flex-col mc-gap-sm">
							...
							<div class="mc-form-group">
								<input type="text" class="mc-input" name="ncarta"
									   placeholder="Numero della carta (16 cifre)">
							</div>
						...
						<div class="mc-form-group">
							...
							<div class="mc-flex-row mc-gap-sm">
								<input type="text" class="mc-input" name="codiceSconto" id="codiceSconto"
									   placeholder="Es. CLICK10" style="flex: 1;">
								<button id="btn-codice-sconto" type="button"
										class="mc-btn mc-btn--outline mc-btn--sm">Applica</button>
							</div>
						</div>

						<button type="submit" class="mc-btn mc-btn--primary mc-btn--block mc-mt-md">Procedi al
							Pagamento</button>
						<a href="<c:url value='/paziente/prenotazione?action=annulla'/>"
						   class="mc-btn mc-btn--outline mc-btn--danger mc-btn--block">Annulla Prenotazione</a>
					</form>
				</div>
			</div>
		</div>
