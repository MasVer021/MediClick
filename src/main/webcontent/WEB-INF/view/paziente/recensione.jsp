	...
	<div class="mc-card mc-card--generic ">
		...
		<div class="mc-card__body mc-flex-col mc-gap-md">
			<div class="mc-flex-col">
				<span class="mc-text-muted mc-font-xs">Medico</span> <span class="mc-text-bold mc-font-md">Dott. ${prenotazione.erogazionePrestazione.medico.cognome}</span>
			</div>
			<div class="mc-flex-col">
				<span class="mc-text-muted mc-font-xs">Prestazione</span> <span class="mc-text-bold mc-font-md">${prenotazione.erogazionePrestazione.catalogoPrestazioni.nome}</span>
			</div>
			<c:if test="${not empty recensione}">
				<div class="mc-flex-col">
					<span class="mc-text-muted mc-font-xs">Commento</span> <span class="mc-text-bold mc-font-md"> <c:out value="${recensione.commento}" />
					</span>
				</div>
				<div class="mc-flex-col">
					<span class="mc-text-muted mc-font-xs">Voto</span> <span class="mc-text-bold mc-font-md">${recensione.voto}</span>
				</div>
				<a class="mc-btn mc-btn--outline mc-btn--sm" href="<c:url value='/paziente/prenotazioni'/>">Torna alle prenotazioni</a>
			</c:if>
			<c:if test="${empty recensione}">
				<form action="<c:url value='/paziente/recensione'/>" method="post" novalidate>
					...
					<div class="mc-form-group">
						<label class="mc-label" for="voto">Voto</label> <input type="number" class="mc-input" id="voto" name="voto" min="1" max="5"></input>
					</div>
