		...
		<div class="mc-card mc-card--generic ">
			...
			<div class="mc-card__body mc-flex-col mc-gap-md">
				<div class="mc-flex-col">
					...
					<span class="mc-text-bold mc-font-md">Dott.
						${prenotazione.erogazionePrestazione.medico.cognome}</span>
				</div>
				<div class="mc-flex-col">
					<span class="mc-text-muted mc-font-xs">Prestazione</span>
					<span
						  class="mc-text-bold mc-font-md">${prenotazione.erogazionePrestazione.catalogoPrestazioni.nome}</span>
				</div>
				...
				<c:if test="${not empty recensione}">
					<div class="mc-flex-col">
						...
						<span class="mc-text-bold mc-font-md">
					...
					<a class="mc-btn mc-btn--outline mc-btn--sm" href="<c:url value='/paziente/prenotazioni'/>">Torna
						alle prenotazioni</a>
				</c:if>
				...
				<c:if test="${empty recensione}">
					<form action="<c:url value='/paziente/recensione'/>" method="post" novalidate>
						...
						<div class="mc-form-group">
							...
							<textarea class="mc-textarea" id="commento" name="commento" rows="4"
									  placeholder="Parlaci brevemente della tua esperienza ..."></textarea>
						</div>
