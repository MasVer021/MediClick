	...
	<c:if test="${not empty prenotazione}">
		...
		<div class="mc-flex-row mc-justify-around">
			<div class="mc-flex-col mc-justify-around mc-gap-md">
				...
				<p>
					Dott.
					<c:out value="${prenotazione.erogazionePrestazione.medico.cognome} ${prenotazione.erogazionePrestazione.medico.nome}" />
				</p>
				<p>
					P. IVA:
		...
		<div class="mc-flex-col mc-justify-around mc-gap-md">
			...
			<p>
				Presso:
				<c:out value="${prenotazione.erogazionePrestazione.studio.nomeSede} - ${prenotazione.erogazionePrestazione.studio.indirizzoMaps}, ${prenotazione.erogazionePrestazione.studio.citta}" />
			</p>
		</div>
		<div class="mc-flex-col mc-justify-around mc-gap-md">
			...
			<c:if test="${not empty prenotazione.codiceSconto}">
				<p>
					...
					<c:out value="${prenotazione.codiceSconto.codice}(${prenotazione.codiceSconto.valorePercentuale}%)" />
				</p>
			</c:if>
		</div>
		<div class="mc-flex-col mc-justify-around mc-gap-md">
			<p>Prestazione sanitaria esente da IVA ai sensi dell'art. 10, comma 1, n. 18, del D.P.R. n. 633/1972.</p>
		</div>
