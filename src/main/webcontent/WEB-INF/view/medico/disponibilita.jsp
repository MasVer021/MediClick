		...
		<div class="mc-card__body">
			<form action="${pageContext.request.contextPath}/medico/disponibilita" method="POST" id="disponibilita-medico">
				<div class="mc-form-group">
					<label class="mc-label" for="dataGiornata">Data:</label> <input class="mc-input" type="date" id="dataGiornata" name="dataGiornata" required>
				</div>
				<div class="mc-form-group">
					<label class="mc-label" for="oraInizio">Dalle ore:</label> <input class="mc-input" type="time" id="oraInizio" name="oraInizio" step="1800" required>
				</div>
				<div class="mc-form-group">
					<label class="mc-label" for="oraFine">Alle ore:</label> <input class="mc-input" type="time" id="oraFine" name="oraFine" step="1800" required>
				</div>
				<div class="mc-form-group">
					<label class="mc-label" for="studioId">Seleziona lo Studio:</label> <select class="mc-select" id="studioId" name="studioId" required>
