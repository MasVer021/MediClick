				...
				<div class="mc-card__body">
					<form action="${pageContext.request.contextPath}/medico/dashboard" method="GET">
						<div class="mc-form-group">
							...
							<input class="mc-input" type="date" id="dataInizio" name="dataInizio" value="${dataInizio}"
								   required>
						</div>
						<div class="mc-form-group">
							<label class="mc-label" for="dataFine">Data fine</label>
							<input class="mc-input" type="date" id="dataFine" name="dataFine" value="${dataFine}"
								   required>
						</div>
