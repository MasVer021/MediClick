		...
		<div class="mc-card__body">
			<form action="${pageContext.request.contextPath}/medico/profilo" method="POST" id="form-profilo-medico">
				...
				<div class="mc-form-group">
					<label class="mc-label" for="nome">Nome</label> <input class="mc-input" type="text" id="nome" name="nome" value="${medico.nome}" required>
				</div>
				<div class="mc-form-group">
					<label class="mc-label" for="cognome">Cognome</label> <input class="mc-input" type="text" id="cognome" name="cognome" value="${medico.cognome}" required>
				</div>
				<div class="mc-form-group">
					<label class="mc-label" for="pIva">Partita IVA</label> <input class="mc-input" type="text" id="pIva" name="pIva" value="${medico.pIva}" required maxlength="11">
				</div>
				<div class="mc-form-group">
					<label class="mc-label" for="regimeFiscaleId">Regime Fiscale</label> <select class="mc-select" id="regimeFiscaleId" name="regimeFiscaleId" required>
						...
						<c:forEach var="regime" items="${regimi}">
							<option value="${regime.id}" ${regime.id==medico.regimeFiscaleId ? 'selected' : ''
											}>${regime.nome} (${regime.aliquotaDefault}%)</option>
						</c:forEach>
					</select>
				</div>
				<div class="mc-form-group">
					<label class="mc-label" for="bio">Biografia Professionale</label>
					<textarea class="mc-textarea" id="bio" name="bio" rows="4" cols="50"><c:out value="${medico.bio}" /></textarea>
				</div>
			...
			<form action="${pageContext.request.contextPath}/medico/profilo" method="POST" enctype="multipart/form-data">
				...
				<div class="mc-form-group">
					...
					<div class="mc-photo-upload">
						<img id="preview-foto" class="mc-image-preview" src="#" alt="Anteprima foto" Style="display: none"> <label for="fotoprofilo" class="mc-btn-upload">Scegli Foto Profilo</label> <input type="file" id="fotoprofilo" name="foto" class="mc-file-input" accept="image/*">
					</div>
				</div>
	...
	<div class="mc-card mc-card--generic">
		...
		<div class="mc-card__footer mc-flex-col">
			...
			<form action="${pageContext.request.contextPath}/medico/profilo" method="POST" id="form-prestazioni-medico">
				...
				<div class="mc-form-group">
					<label class="mc-label" for="studioId">Seleziona lo Studio (Sede)</label> <select class="mc-select" id="studioId" name="studioId" required>
				...
				<div class="mc-form-group">
					<label class="mc-label" for="catalogoId">Seleziona la Prestazione</label> <select class="mc-select" id="catalogoId" name="catalogoId" required>
				...
				<div class="mc-form-group">
					<label class="mc-label" for="durata">Durata della visita (minuti)</label> <input class="mc-input" type="number" id="durata" name="durata" min="30" step="30" placeholder="30" required>
				</div>
				<div class="mc-form-group">
					<label class="mc-label" for="prezzo">Prezzo Lordo (&euro;)</label> <input class="mc-input" type="number" id="prezzo" name="prezzo" step="0.01" min="0" placeholder="Es. 80.00" required>
				</div>
