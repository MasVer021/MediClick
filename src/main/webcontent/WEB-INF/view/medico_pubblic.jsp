...
<main class="mc-container">
	<div class="mc-card mc-card--generic mc-card--medium">
		...
		<div class="mc-flex-col mc-align-center mc-mb-xl">
			...
			<form method="get" action="${pageContext.request.contextPath}/paziente/prenotazione" id="Form-prenotazione">
				<div class="mc-form-group">
				    <label class="mc-label">Studio Medico</label>
				    <select name="studio" id="studioSelect" class="mc-select" data-medico-id="${profiloMedico.medico.id}">
