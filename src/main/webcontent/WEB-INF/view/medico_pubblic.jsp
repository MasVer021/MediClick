		...
		<div class="mc-card mc-card--generic mc-card--medium">
			...
			<div class="mc-flex-col mc-align-center mc-mb-xl">
				<c:choose>
					<c:when test="${not empty profiloMedico.medico.fotoprofilo}">
						<img class="medico-avatar"
							 src="data:image/jpeg;base64,${profiloMedico.medico.fotoprofiloBase64}"
							 alt="Foto Dr. ${profiloMedico.medico.nome} ${profiloMedico.medico.cognome}" />
					</c:when>
					<c:otherwise>
				...
				<h2 class="mc-card__title mc-mt-md">DR. ${profiloMedico.medico.cognome} ${profiloMedico.medico.nome}
				</h2>
			</div>
			<form method="get" action="<c:url value='/paziente/prenotazione'/>" id="Form-prenotazione">
				<div class="mc-form-group">
					...
					<select name="studio" id="studioSelect" class="mc-select"
							data-medico-id="${profiloMedico.medico.id}">
				...
				<div class="mc-form-group">
					...
					<select name="prestazione" id="prestazioneSelect" class="mc-select">
				...
				<button id="btnConferma" class="mc-btn mc-btn--outline mc-btn--lg mc-mt-lg mc-btn--block" type="submit"
