			...
			<div class="mc-search-layout">
				<aside class="mc-search-layout__sidebar">
					<div class="mc-card mc-card--primary">
						...
						<form method="get" action="${pageContext.request.contextPath}/search" class="mc-card__body mc-flex-col mc-gap-md">
								...
								<div class="mc-card__body mc-p-md mc-flex-col mc-gap-sm mc-justify-between">
									<div>
										...
										<div class="mc-flex-row mc-justify-between mc-align-center mc-mb-sm">
											...
											<span class="mc-text-bold">&#9733; ${m.valoreRecensioni}/5 (${m.numeroRecensioni})</span>
										</div>
				                	...
				                	<a href="${pageContext.request.contextPath}/profiloMedico?id=${m.medico.id}" class="mc-btn mc-btn--primary mc-btn--block mc-mt-sm">
