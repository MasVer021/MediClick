				...
				<div class="card-medico">
					<c:choose>
						<c:when test="${not empty m.medico.fotoprofiloBase64}">
							<img class="medico-avatar" src="data:image/jpeg;base64,${m.medico.fotoprofiloBase64}" alt="Foto Dr. ${m.medico.nome} ${m.medico.cognome}" />
						</c:when>
						<c:otherwise>
					...
					<div class="card-body">
                		...
                		<div class="dettagli-prenotazione">
	                    	<c:choose>
	                        	...
	                        	<c:otherwise>
	                            	<p>Nessuna disponibilit&agrave; imminente</p>
	                        	</c:otherwise>
	                    	</c:choose>
	                	</div>
