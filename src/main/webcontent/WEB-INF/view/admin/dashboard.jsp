												...
												<c:set var="certificatoTrovato" value="" /> 
													...
													<c:choose>
														<c:when test="${trovato}">
															...
															<a	href="${pageContext.request.contextPath}/admin/downloadCertificato?id=${certificatoTrovato.id}"	target="_blank" class="cert-link"	title="Visualizza ${certificatoTrovato.nomeFile}">
																...
																<c:when test="${certificatoTrovato.stato == 'IN_REVISIONE' }">
																	<div class="mc-table-action-cell mc-mt-sm">
																		...
																		<form method="post"	action="${pageContext.request.contextPath}/admin/approvaMedico">
																			<input type="hidden" name="certificatoId" value="${certificatoTrovato.id}"> 
