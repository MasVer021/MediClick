            ...
            <div class="mc-card__body">
                <form action="${pageContext.request.contextPath}/admin/catalogo" method="post">
                    ...
                    <div class="mc-form-group">
                        ...
                        <input class="mc-input" type="text" id="nomeCategoria" name="nomeCategoria" required placeholder="es. Cardiologia">
                    </div>
            ...
            <div class="mc-card__body">
                <form action="${pageContext.request.contextPath}/admin/catalogo" method="post">
                    ...
                    <div class="mc-form-group">
                        ...
                        <input class="mc-input" type="text" id="nomePrestazione" name="nomePrestazione" required placeholder="es. Visita Cardiologica">
                    </div>
            ...
            <table class="mc-table mc-table--zebra">
                ...
                <tbody>
                    <c:forEach items="${prestazioni}" var="pr">
                        <tr>
                            <td><span class="mc-text-bold"><c:out value="${pr.nome}"/></span></td>
                            <td><c:out value="${pr.categoria.nome}"/></td>
                            <td><c:out value="${pr.descrizione}"/></td>
                            <td>
                                <span class="mc-badge ${pr.stato.label == 'Attiva' || pr.stato.label == 'Attivo' ? 'mc-badge--success' : 'mc-badge--secondary'}">
                ...
                <tbody>
                    <c:forEach items="${categorie}" var="c">
                        <tr>
                            ...
                            <td><span class="mc-text-bold"><c:out value="${c.nome}"/></span></td>
                        </tr>
                    </c:forEach>
