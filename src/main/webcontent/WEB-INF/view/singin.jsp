	...
	<%@ page contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
		...
		<main class="mc-container">
			<div class="mc-card mc-card--small mc-card--primary mc-card--generic">
				<form method="post" id="registrazioneForm" action="<c:url value='/singin?medico=${isMedico}'/>"
					  enctype="multipart/form-data" class="mc-card__body" novalidate>


					<div class="mc-form-group">
						<label class="mc-label" for="email">Indirizzo Email</label>
						<input class="mc-input" type="email" id="email" name="email" placeholder="esempio@email.com"
							   required>
					</div>
					...
					<div class="mc-form-group">
						...
						<input class="mc-input" type="password" id="password" name="password"
					...
					<div class="mc-form-group">
						...
						<input class="mc-input" type="password" id="passwordRipetuta" name="passwordRipetuta"
					...
					<div class="mc-form-group">
						...
						<input class="mc-input" type="text" id="nome" name="nome" placeholder="Inserisci il tuo nome"
							   required>
					</div>
					...
					<div class="mc-form-group">
						...
						<input class="mc-input" type="text" id="cognome" name="cognome"
					...
					<c:if test="${isMedico}">
						...
						<div class="mc-form-group">
							...
							<textarea class="mc-textarea" id="Bio" name="Bio" rows="4"
									  placeholder="Parlaci brevemente della tua esperienza medica..."></textarea>
						</div>
						...
						<div class="mc-form-group">
							...
							<div class="mc-photo-upload">
								<img id="preview-foto" class="mc-image-preview" src="#" alt="Anteprima foto"
									 Style="display: none">

								<label for="fotoprofilo" class="mc-btn-upload">Scegli Foto Profilo</label>
								<input type="file" id="fotoprofilo" name="fotoprofilo" class="mc-file-input"
									   accept="image/*">
							</div>
						</div>
					</c:if>
					...
					<c:if test="${!isMedico}">
						<div class="mc-form-group">
							...
							<input class="mc-input" type="text" id="CF" name="CF"
								   placeholder="Codice Fiscale a 16 caratteri">
						</div>

						<div class="mc-form-group">
							<label class="mc-label" for="telefono">Numero di Telefono</label>
							<input class="mc-input" type="tel" id="telefono" name="telefono"
					...
					<div class="mc-medico-paziente">
						<c:if test="${!isMedico}">
							<a href="<c:url value='/singin?medico=true'/>" class="mc-link">
								Sei un professionista? Registrati qui
							</a>
						</c:if>
						<c:if test="${isMedico}">
							<a href="<c:url value='/singin'/>" class="mc-link">
