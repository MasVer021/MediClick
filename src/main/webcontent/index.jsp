...
<main>
    <section id="hero">
        <h1>Benvenuti in MediClick</h1>
        <p>La tua salute in un click. Trova il medico giusto per te e prenota subito la tua visita.</p>
        <a href="${pageContext.request.contextPath}/search">Cerca uno Specialista</a>
    </section>
    ...
    <section id="sei-un-medico">
        ...
        <p>Per qualsiasi problema tecnico o nella gestione delle agende, il nostro team dedicato è a tua disposizione all'indirizzo email <a href="mailto:supporto-medici@mediclick.it">supporto-medici@mediclick.it</a>.</p>
    </section>
    ...
    <section id="policy">
        ...
        <p>Hai ulteriori dubbi o necessiti di supporto generale? Non esitare a scriverci al nostro indirizzo: <a href="mailto:supporto@mediclick.it">supporto@mediclick.it</a></p>
    </section>
</main>
