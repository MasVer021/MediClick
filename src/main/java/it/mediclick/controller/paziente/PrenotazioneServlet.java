...
public class PrenotazioneServlet extends HttpServlet
{
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		...
		try
		{
			...
			boolean isNuovaPrenotazione = request.getParameter("studio") != null && request.getParameter("prestazione") != null && request.getParameter("disponibilitaId") != null;
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		...
		try
		{
			...
			if (prenotazioneService.creaPrenotazione(idUtente, IdDisponibilita, idTransazioneEsterno, idErogazione, prezzo_pagato, prezzo_trattenuta, prezzo_netto, prezzo_tasse, idSconto,
					metodoPagamento))
			{
